...
class AppConstants {
  static const String APP_NAME = 'Foodie Tanzania';
  static const double APP_VERSION = 2.0;

  static const String BASE_URL = 'https://admin.foodie.co.tz';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.arabic, languageName: 'Swahili', countryCode: 'SW', languageCode: 'sw'),
